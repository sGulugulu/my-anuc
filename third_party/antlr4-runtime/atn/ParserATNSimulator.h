...
namespace antlr4 {
    namespace atn {
        ...
        public:
            ...
            precedenceTransition(Ref<ATNConfig> const &config, const PrecedencePredicateTransition *pt,
        ...
        protected:
            ...
            virtual void
            closureCheckingStopState(Ref<ATNConfig> const &config, ATNConfigSet *configs, ATNConfig::Set &closureBusy,
            ...
            virtual Ref<ATNConfig>
            getEpsilonTarget(Ref<ATNConfig> const &config, const Transition *t, bool collectPredicates,
                             bool inContext, bool fullCtx, bool treatEofAsEpsilon);

            virtual Ref<ATNConfig> actionTransition(Ref<ATNConfig> const &config, const ActionTransition *t);

            virtual Ref<ATNConfig>
            predTransition(Ref<ATNConfig> const &config, const PredicateTransition *pt, bool collectPredicates,

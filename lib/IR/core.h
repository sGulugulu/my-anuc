...
namespace anuc {
    ...
    class PhiInst : public Instruction {
        ...
        unsigned valueNum;
    public:
        PhiInst(BasicBlock *parent, Type *ty, RegisterVar *result): Instruction(VK_PhiInst, parent), ty(ty), result(result) {}
    ...
    class AddInst : public Instruction {
        RegisterVar *result;
    public:
        AddInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_AddInst, parent),result(result){
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
        ...
        void print() {
            cout << " " << result->toString() << " = add nsw i32" <<
    ...
    public:
        ...
        void print() {
            cout << " " << result->toString() << " = sub nsw i32" <<
            operands[0].value->toString() << "," << operands[1].value->toString()
            <<endl;
        }
        Value *getL() {return operands[0].value;}
    ...
    class MulInst : public Instruction {
        RegisterVar *result;
    public:
        MulInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_MulInst, parent),result(result){
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
        ...
        void print() {
            cout << " " << result->toString() << " = mul nsw i32" <<
            operands[0].value->toString() << "," << operands[1].value->toString()
            <<endl;
        }
        Value *getL() {return operands[0].value;}
    ...
    class DivInst : public Instruction {
        RegisterVar *result;
    public:
        DivInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_DivInst, parent),result(result){
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
        ...
        void print() {
            cout << " " << result->toString() << " = div nsw i32" <<
            operands[0].value->toString() << "," << operands[1].value->toString()
            <<endl;
        }
        Value *getL() {return operands[0].value;}
    ...
    class RemInst : public Instruction {
        RegisterVar *result;
    public:
        RemInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_RemInst, parent), result(result) {
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
        ...
        void print() {
            cout << " " << result->toString() << " = srem nsw i32" <<
                 operands[0].value->toString() << "," << operands[1].value->toString()
                 << endl;
        }
    ...
    class FAddInst : public Instruction {
        RegisterVar *result;
    public:
        FAddInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_FAddInst, parent), result(result) {
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
    ...
    class FSubInst : public Instruction {
        RegisterVar *result;
    public:
        FSubInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_FSubInst, parent), result(result) {
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
    ...
    class FMulInst : public Instruction {
        RegisterVar *result;
    public:
        FMulInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_FMulInst, parent), result(result) {
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
    ...
    class FDivInst : public Instruction {
        RegisterVar *result;
    public:
        FDivInst(BasicBlock *parent, Value *L, Value *R, RegisterVar *result) : Instruction(VK_FDivInst, parent), result(result) {
            Use op0(L, this);
            Use op1(R, this);
            operands.push_back(op0);
            operands.push_back(op1);
    ...
    class CallInst : public Instruction {
        ...
        RegisterVar *ret;
    public:
        CallInst(BasicBlock *parent, Function* fn, vector<Value *> args, RegisterVar* ret):  Instruction(VK_CallInst, parent),
        fn(fn), args(args), ret(ret) {
            if(isa<VoidType>(fn->getFuncType())) return;
            for(int i = 0; i < args.size(); ++i) {
                Use op(args[i], this);
                operands.push_back(op);
                args[i]->insertBackToUses(&operands[i]);
            }
            ret->setInst(this);
        }
        bool static classof(Value *v) { return v->getKind() == VK_RetInst; }
        void print() {
            ...
            << " @" << fn->getName() << "(";
            for (int i = 0; i < args.size(); ++i) {
                cout << args[i]->getType()->toString() << args[i]->toString();
